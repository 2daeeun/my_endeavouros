...
sudo ln -sf ~/Documents/github/my_endeavouros/home/.config/htop ~/.config/
sudo ln -sf ~/Documents/github/my_endeavouros/home/.config/i3 ~/.config/
sudo ln -sf ~/Documents/github/my_endeavouros/home/.config/neofetch ~/.config/
